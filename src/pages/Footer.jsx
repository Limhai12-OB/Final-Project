      ...
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <div className="max-w-xs">
            <img src="/image/logo.png" className="w-32" />
            <p className="leading-relaxed mt-2 text-[15px]">
              Thanks for visiting! We appreciate you taking the time to explore
              our site. We hope you found what you were looking for and enjoyed
              your visit. If you have any questions, please feel free to contact
              us. We are always happy to help!
            </p>
            <form className="mt-5">
              <Link
                to={"/contactus"}
                className="text-xl text-white  bg-gray-600 rounded-md px-3 py-2 "
              >
                Contact Us
              </Link>
            </form>
